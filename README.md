...
`Proyecto Final de Ñañez Nahir Nicolás` para el curso de ReactJS `Coder House` (2022).
...
## Backend
 ...
 tiene un backend realizado con Firebase,tienen que generar su backend en firebase sino local con data .
